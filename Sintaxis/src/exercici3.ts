...
var comptador_de_visites : number = 0; //En esta variable de aquí le estamos asignando el numero que va a tener el contador, que va a ser 0
...
} while (comptador_de_visites < visites_maximes){ //En caso de que el contador de visitas sea más
